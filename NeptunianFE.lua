...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game:GetService("Players").LocalPlayer.Character.WaterHubV1
...
Character=Player.Character.WaterHubV1
...
Align(Hat.Handle,AlignChar.WaterHubV1.Model.Part,Vector3.new(0,0,0),Vector3.new(0,0,0))
